  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        notes: { type: "string", description: "Notas personales (opcional)" },
        reminderAt: { type: "string", description: "Fecha/hora de recordatorio en ISO 8601 (opcional)" },
        platform: { type: "string", description: "Plataforma detectada: youtube, github, steam, etc. (opcional)" },
        contentType: { type: "string", description: "Tipo de contenido: video, code, game, article, etc. (opcional)" },
        readingStatus: { type: "string", enum: ["inbox", "reading", "done"], description: "Estado de lectura (por defecto: inbox)" },
      },
      required: ["url", "title"],
    },
  },
